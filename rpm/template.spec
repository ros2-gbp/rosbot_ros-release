...
%description
The rosbot_joy package to handle joystick inputs for the rosbot drive (via
teleop_twist_joy).
...
%changelog
* Mon Jun 29 2026 Husarion <support@husarion.com> - 1.1.1-1
- Autogenerated by Bloom

* Tue Apr 21 2026 Husarion <support@husarion.com> - 1.0.0-1
- Autogenerated by Bloom
